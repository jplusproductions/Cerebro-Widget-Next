...
export type AuthSessionWhereInput = {
  ...
  authSessionId?: Prisma.UuidFilter<"AuthSession"> | string
...
export type AuthSessionWhereUniqueInput = Prisma.AtLeast<{
  authSessionId?: string
  token?: string
  userId_createdAt?: Prisma.AuthSessionUserIdCreatedAtCompoundUniqueInput
  AND?: Prisma.AuthSessionWhereInput | Prisma.AuthSessionWhereInput[]
  OR?: Prisma.AuthSessionWhereInput[]
  NOT?: Prisma.AuthSessionWhereInput | Prisma.AuthSessionWhereInput[]
  userId?: Prisma.UuidFilter<"AuthSession"> | string
  ...
  updatedAt?: Prisma.DateTimeFilter<"AuthSession"> | Date | string
  User?: Prisma.XOR<Prisma.UserScalarRelationFilter, Prisma.UserWhereInput>
}, "authSessionId" | "token" | "userId_createdAt">
...
export type AuthSessionScalarWhereWithAggregatesInput = {
  ...
  authSessionId?: Prisma.UuidWithAggregatesFilter<"AuthSession"> | string
...
export type AuthSessionUserIdCreatedAtCompoundUniqueInput = {
  userId: string
  createdAt: Date | string
}
...
export type AuthSessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"authSessionId" | "userId" | "token" | "expiresAt" | "createdAt" | "updatedAt", ExtArgs["result"]["authSession"]>
...
export interface AuthSessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `authSessionId`
   * const authSessionWithAuthSessionIdOnly = await prisma.authSession.findMany({ select: { authSessionId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuthSessions and only return the `authSessionId`
   * const authSessionWithAuthSessionIdOnly = await prisma.authSession.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AuthSessions and only return the `authSessionId`
   * const authSessionWithAuthSessionIdOnly = await prisma.authSession.updateManyAndReturn({
   *   select: { authSessionId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuthSessionFieldRefs {
  readonly authSessionId: Prisma.FieldRef<"AuthSession", 'String'>
